...
export default function ConditionalIndicatorDisplay({
  ...
  useEffect(() => {
    if (conditionalQuestion) {
      // Check if user has already answered the Yes/No question
      const questionField = conditionalQuestion.field;
      const existingAnswer = fieldValues[questionField];
      
      if (existingAnswer !== undefined && existingAnswer !== null) {
        const answer = existingAnswer > 0 ? "yes" : "no";
      ...
      // No conditional question, always show
      setConditionMet(true);
      setShouldShowIndicator(true);
    }
  }, [fieldValues, conditionalQuestion, onConditionChange]);
            ...
            <AlertDescription>
              <div className="space-y-2">
                ...
                <p className="text-sm text-orange-700">
                  This indicator is not applicable because there are no {indicator.code === "CT001" ? "pulmonary TB" : "TB"} patients in your catchment area.
                </p>
          ...
          <div className="space-y-3">
            ...
            {indicator.conditions && (
              <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                ...
                <p className="text-sm text-blue-700 mt-1">{indicator.conditions}</p>
              </div>
            )}
            ...
            {indicator.source_of_verification && (
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <Badge variant="secondary">{indicator.source_of_verification}</Badge>
              </div>
            )}
