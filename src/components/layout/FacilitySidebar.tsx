...
export default function FacilitySidebar({
	...
	return (
		<div className="flex flex-col h-full min-h-screen flex-1 min-h-0 h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-r border-gray-800">
