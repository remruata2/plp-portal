...
export default function IncentivesSummary({
	...
	const [incentivesData, setIncentivesData] = useState<IncentivesData | null>(
		null
	);
			...
			<Card className="w-full">
				...
				<CardContent>
					<div className="text-center text-gray-500 py-8">
						...
						<p className="text-sm">
							Incentives will be calculated automatically when you submit PLP
							report.
						</p>
					</div>
				</CardContent>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-blue-600 mt-1">
										Distributed to {incentivesData.workers.length} employee
										{incentivesData.workers.length !== 1 ? "s" : ""}
									</p>
								</div>
					...
					<div className="flex items-start gap-3">
						...
						<div className="text-sm text-blue-800">
							...
							<ul className="space-y-1 text-xs">
								...
								<li>
									• ALL incentives go directly to individual employees - no
									facility-level allocation
								</li>
								<li>
									• Each employee receives their allocated amount adjusted by
									facility performance percentage
								</li>
								<li>
									• Employee allocation follows the official
									WORKER_ALLOCATION_SYSTEM guidelines
								</li>
								<li>
