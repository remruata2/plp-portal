    ...
    <div className="container mx-auto py-8 space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Submit your facility's monthly health data indicators
        </p>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleInputChange("reportMonth", value)}
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="2024-12">
                        December 2024
                      </SelectItem>
                      <SelectItem value="2024-11">
                        November 2024
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("indicatorValue", e.target.value)}
                    min="0"
                    step="0.01"
                  />
                </div>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-start gap-2">
            ...
            <p className="text-sm text-gray-600">
              Data must be submitted by the monthly deadline to be included in performance calculations
            </p>
          </div>
          <div className="flex items-start gap-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            <p className="text-sm text-gray-600">
              Late submissions will not be accepted and may affect your facility's performance metrics
            </p>
          </div>
          <div className="flex items-start gap-2">
            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            <p className="text-sm text-gray-600">
              Contact your administrator if you need to request an extension or have questions
            </p>
          </div>
        </CardContent>
      </Card>
