...
export function groupFieldsByIndicators(
	...
	const indicatorMapping: Record<string, { code: string; name: string }> = {
		...
		anc_footfall_sc: { code: "AF001_SC", name: "Total ANC footfall" },
		anc_footfall_ahwc: {
			code: "AF001_AHWC",
		...
		tb_screenings: { code: "TS001_PHC", name: "Individuals screened for TB" }, // Will be mapped based on facility type
		tb_screenings_phc: {
			code: "TS001_PHC",
		...
		ncd_diagnosed_tx_completed: {
			code: "ND001",
			name: "NCD Diagnosed & Treatment initiated",
		},
	...
	const indicatorOrder = [
		...
		"TC001_SC", // 3a. Teleconsultation
		"TC001_AHWC", // 3b. Teleconsultation
		...
		"ND001", // 16. NCD Diagnosed & Treatment initiated
